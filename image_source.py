...
def data_load(args): 
    ...
    if args.dset == 'DomainNet':
        dset_loaders["source_tr"], dset_loaders["source_te"] = get_domainnet_dloader(args.base_path,
                                                                                     args.domains[args.s],
                                                                                     args.batch_size,
                                                                                     args.worker,
                                                                                     Isshuffle=True)
        _, dset_loaders["test"] = get_domainnet_dloader(args.base_path,
                                                        args.domains[args.t],
                                                        args.batch_size * 2,
                                                        args.worker,
                                                        Isshuffle=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--net', type=str, default='resnet50', help="vgg16, resnet50, resnet101, vit")
...
# CUDA_VISIBLE_DEVICES=1 python image_source.py --trte val --output ckps/source/ --da uda --dset office-home --max_epoch 100 --s 1 > log_s1_office-home.txt

# CUDA_VISIBLE_DEVICES=2 python image_source.py --trte val --output ckps/source/ --da uda --dset office-home --max_epoch 100 --s 2 > log_s2_office-home.txt

# CUDA_VISIBLE_DEVICES=3 python image_source.py --trte val --output ckps/source/ --da uda --dset office-home --max_epoch 100 --s 3 > log_s3_office-home.txt
